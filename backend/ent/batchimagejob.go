...
func (*BatchImageJob) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case batchimagejob.FieldID, batchimagejob.FieldUserID, batchimagejob.FieldAPIKeyID, batchimagejob.FieldAccountID, batchimagejob.FieldRoutedGroupID, batchimagejob.FieldItemCount, batchimagejob.FieldSuccessCount, batchimagejob.FieldFailCount, batchimagejob.FieldCancelledCount, batchimagejob.FieldRetryCount, batchimagejob.FieldVersion:
...
func (_m *BatchImageJob) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case batchimagejob.FieldRoutedGroupID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
