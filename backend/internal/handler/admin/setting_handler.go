...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIStickyEscapeEnabled:                              settings.OpenAIStickyEscapeEnabled,
		OpenAIStickyEscapeTTFTMs:                               settings.OpenAIStickyEscapeTTFTMs,
		OpenAIStickyEscapeErrorRate:                            settings.OpenAIStickyEscapeErrorRate,
		GatewayPlatformEnabled:                                 settings.GatewayPlatformEnabled,
