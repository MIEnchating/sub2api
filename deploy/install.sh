...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/MIEnchating/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="MIEnchating/sub2api"
...
Documentation=https://github.com/MIEnchating/sub2api
