export default {
    accounts: {
      ...
      toolDiagnostics: {
        ...
        open: 'Tool diagnostics',
        window: 'OpenAI tool forwarding events from the last 24 hours',
        time: 'Time',
        status: 'Status',
        inbound: 'Inbound tools',
        outbound: 'Forwarded tools',
        missing: 'Missing tools',
        requestId: 'Request ID',
        empty: 'No tool diagnostic events in the last 24 hours',
        loadFailed: 'Failed to load tool diagnostics',
        unknown: 'Not checked',
        diagnoses: {
          tools_present: 'OK',
          no_tools_declared: 'No tools declared',
          gateway_dropped_tools: 'Gateway dropped tools',
          gateway_dropped_discovered_tools: 'Gateway dropped discovered tools',
          client_discovered_tools_not_declared: 'Tool search continuation mismatch',
          tool_history_without_declarations: 'Tool history lacks declarations',
          tools_disabled: 'Tools disabled',
          continuation_context_not_inspected: 'Continuation context needs review',
      ...
      openai: {
        ...
        legacyProtectionTitle: 'Legacy preset configuration',
        legacyProtectionDescription: 'This account still uses a legacy preset. Restore its original settings before independently editing managed fingerprint or transport settings. Adaptive concurrency is configured separately.',
        legacyProtectionRestore: 'Restore original settings',
        legacyProtectionRestoreTitle: 'Restore original settings?',
        legacyProtectionRestoreMessage: 'Immediately restore the identity and transport settings managed by the legacy preset and release its controls. Later manual concurrency changes are retained. Adaptive concurrency settings are unchanged.',
        legacyProtectionRestored: 'Original settings restored; account settings can now be edited independently',
        legacyProtectionRestoreFailed: 'Failed to restore original settings',
        adaptiveConcurrencyTitle: 'Adaptive concurrency control',
        adaptiveConcurrencyDescription: 'Controls runtime concurrency independently of Codex fingerprint and TLS settings. Enable this section, select adaptive concurrency and automatic adjustment, then save with Update at the bottom.',
        adaptiveConcurrencyEnabled: 'Enable adaptive concurrency control',
        ...
        codexTicketAccountEnabledDesc: 'Uses the dedicated gateway harvest proxy. Pro uses 292; Team uses 332. Tickets last at most 240 seconds by default and renew 60 seconds early. Required 292 routing cookies are collected automatically and shared across models within this account only.',
