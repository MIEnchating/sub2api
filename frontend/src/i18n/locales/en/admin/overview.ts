export default {
    ...
    groups: {
      ...
      form: {
        ...
        codexQuotaOverdraftHint: 'Account settings take precedence over group settings. Unset groups inherit the global switch; a global off always disables it.',
        codexQuotaOverdraftInherit: 'Inherit global setting',
